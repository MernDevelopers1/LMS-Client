...
const sidebarItems = [
  ...
  { label: "Students Management", href: "/admin/students" },
  { label: "Classes Management", href: "/admin/classes" },
  { label: "Sections Management", href: "/admin/sections" },
  { label: "Subjects Management", href: "/admin/subjects" },
  { label: "Lecture Slots Management", href: "/admin/lecture-slots" },
  { label: "Live Classes Management", href: "/admin/live-classes" },
  { label: "Timetables Management", href: "/admin/timetables" },
